...
module.exports = function (wasm) {
  ...
  function sr25519_pairFromSeed () {
    const expected = [
      '1ec20c6cb85bf4c7423b95752b70c312e6ae9e5701ffb310f0a9019d9c041e0af98d66f39442506ff947fd911f18c7a7a5da639a63e8d3b4e233f74143d951c1',
    ...
    assert(u8aToHex(pair) === `0x${expected.join('')}`, 'ERROR: pairFromSeed() does not match');
  }

  function sr25519_devFromSeed () {
    const expected = [
      '05d65584630d16cd4af6d0bec10f34bb504a5dcb62dba2122d49f5a663763d0afd190cce74df356432b410bd64682309d6dedb27c76845daf388557cbac3ca34',
      '46ebddef8cd9bb167dc30878d7113b7e168e6f0646beffd77d69d39bad76b47a'
    ];
    const pair = wasm.sr25519KeypairFromSeed(
      hexToU8a('0xfac7959dbfe72f052e5a0c3c8d6530f202b02fd8f9f5ca3580ec8deb7797479e')
    );

    console.log('\tSEC', u8aToHex(pair.slice(0, 64)));
    console.log('\tPUB', u8aToHex(pair.slice(64)));

    assert(u8aToHex(pair) === `0x${expected.join('')}`, 'ERROR: devFromSeed() does not match');
  }
  ...
  function sr25519_verifyExisting () {
    ...
    const SIGNATURE = hexToU8a(
      '0x5a9755f069939f45d96aaf125cf5ce7ba1db998686f87f2fb3cbdea922078741a73891ba265f70c31436e18a9acd14d189d73c12317ab6c313285cd938453202'
    );
  ...
  function sr25519_deriveHard () {
    ...
    const derived = wasm.sr25519DeriveKeypairHard(pair, hexToU8a(
      '0x0c666f6f00000000000000000000000000000000000000000000000000000000'
    ));
  ...
  function sr25519_deriveHardKnown () {
    const derived = wasm.sr25519DeriveKeypairHard(
      hexToU8a(
        '0x28b0ae221c6bb06856b287f60d7ea0d98552ea5a16db16956849aa371db3eb51fd190cce74df356432b410bd64682309d6dedb27c76845daf388557cbac3ca3446ebddef8cd9bb167dc30878d7113b7e168e6f0646beffd77d69d39bad76b47a'
      ),
  ...
  function sr25519_deriveSoftKnown () {
    const derived = wasm.sr25519DeriveKeypairSoft(
      hexToU8a(
        '0x28b0ae221c6bb06856b287f60d7ea0d98552ea5a16db16956849aa371db3eb51fd190cce74df356432b410bd64682309d6dedb27c76845daf388557cbac3ca3446ebddef8cd9bb167dc30878d7113b7e168e6f0646beffd77d69d39bad76b47a'
      ),
  ...
  function sr25519_deriveSoftPubkey () {
    const derived = u8aToHex(
      wasm.sr25519DerivePublicSoft(
        hexToU8a('0x46ebddef8cd9bb167dc30878d7113b7e168e6f0646beffd77d69d39bad76b47a'),
        hexToU8a('0x0c666f6f00000000000000000000000000000000000000000000000000000000')
      )
    );
